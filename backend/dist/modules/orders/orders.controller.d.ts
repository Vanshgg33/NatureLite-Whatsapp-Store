...
export declare class OrdersController {
    ...
    createGuest(dto: GuestCreateOrderDto): Promise<Order>;
    ...
    updateStatus(id: string, dto: UpdateOrderStatusDto, user: JwtPayload): Promise<Order>;
    updatePaymentStatus(id: string, dto: UpdatePaymentStatusDto): Promise<Order>;
    updateDeliveryWorkflow(id: string, dto: UpdateDeliveryWorkflowDto, user: JwtPayload): Promise<Order>;
    cancelOrder(id: string, dto: CancelOrderDto, user: JwtPayload): Promise<Order>;
    requestReturn(id: string, reason: string, userId: string): Promise<Order>;
    approveReturn(id: string): Promise<Order>;
    rejectReturn(id: string): Promise<Order>;
    completeReturn(id: string): Promise<Order>;
