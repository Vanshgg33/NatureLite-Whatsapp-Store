...
export declare class OrdersService {
    ...
    constructor(orderRepository: OrderRepository, connection: Connection, cartService: CartService, productsService: ProductsService, usersService: UsersService, couponsService: CouponsService, emailService: EmailService, settingsService: SettingsService, storesService: StoresService, storeStockService: StoreStockService, storeSalesService: StoreSalesService, walletService: WalletService);
    ...
    createGuestOrder(dto: GuestCreateOrderDto): Promise<Order>;
    private static readonly VALID_TRANSITIONS;
    updateStatus(id: string, dto: UpdateOrderStatusDto, departmentType?: 'packing' | 'billing' | 'delivery'): Promise<Order>;
    updatePaymentStatus(id: string, dto: UpdatePaymentStatusDto): Promise<Order>;
    updateDeliveryWorkflow(id: string, dto: UpdateDeliveryWorkflowDto, updatedBy: string, departmentType?: 'packing' | 'billing' | 'delivery'): Promise<Order>;
    ...
    requestReturn(userId: string, id: string, reason: string): Promise<Order>;
