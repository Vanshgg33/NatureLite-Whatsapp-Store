...
const defaultTestimonials: Testimonial[] = [
  {
    ...
    location: 'Mumbai',
    rating: 5,
    text: "Switched to Purity Foods's wood-pressed oils 6 months ago — my cholesterol dropped 20 points and my skin has never looked better. The cold-pressed groundnut oil tastes exactly like what my grandmother used to make.",
  ...
  },
  {
    ...
    location: 'Bangalore',
    rating: 5,
    text: "After switching to Purity Foods's organic turmeric and honey, my seasonal allergies have reduced dramatically. As a nutritionist, I now recommend them to all my clients. The purity is unmatched.",
